-- Script d'intégration AlertSystem dans la base de données hôtel BELVEDERE_17_10_2025
-- Ce script ajoute les tables AlertSystem en s'adaptant à la structure existante
...
-- Vérifier le type de la colonne util_id dans def_utilisateur
DECLARE @util_id_type NVARCHAR(50)
SELECT @util_id_type = DATA_TYPE + CASE 
...
WHERE TABLE_NAME = 'def_utilisateur' AND COLUMN_NAME = 'util_id'

PRINT 'Type de util_id: ' + @util_id_type

-- Créer la table Alerte en s'adaptant au type de util_id
...
BEGIN
    ...
    CREATE TABLE [Alerte] (
        ...
        [AppId] int NULL,
        [ExpediteurId] ' + @util_id_type + ' NULL,
        ...
        [DestinataireUserId] ' + @util_id_type + ' NULL,
...
PRINT 'Intégration AlertSystem dans la base de données hôtel BELVEDERE_17_10_2025 terminée avec succès !';
