...
namespace AlertSystem.DataLayer.Interfaces
{
    ...
    public interface IAlerteRepository
    {
        ...
        // Nouvelles méthodes pour la refactorisation
        Task<IEnumerable<Alerte>> GetByGroupIdAsync(Guid groupId);
        Task<IEnumerable<Alerte>> GetPendingForWorkerAsync();
        Task MarkAsProcessedAsync(int alertRecordId);
    }
}
