...
namespace AlertSystem.Models.Entities
{
    public sealed class Alerte
    {
        ...
        // Colonnes pour la phase de test (saisie manuelle)
        public string? destinataireMail { get; set; }
        public string? destinatairenum { get; set; }
        ...
        public ICollection<Destinataire> Destinataires { get; set; } = new List<Destinataire>();
