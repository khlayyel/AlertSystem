-- V̩rification que ExternalRecipientId = DestinataireId

-- 1. V̩rifier que tous les ExternalRecipientId correspondent aux DestinataireId
SELECT 'ExternalRecipientId != DestinataireId' as Check_Type,
       COUNT(*) as Count
FROM Destinataire 
WHERE ExternalRecipientId != CAST(DestinataireId AS NVARCHAR(50));

-- 2. V̩rifier qu'il n'y a pas de valeurs NULL
