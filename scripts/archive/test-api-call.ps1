...
# Tester d'abord si l'application rÃ©pond
...
try {
    ...
    Write-Host "1. VÃ©rifiez que l'application AlertSystem est dÃ©marrÃ©e"
    Write-Host "2. VÃ©rifiez le port dans les logs de l'application"
...
Write-Host ""
Write-Host "=== VÃ‰RIFICATIONS RECOMMANDÃ‰ES ===" -ForegroundColor Yellow
Write-Host "1. VÃ©rifiez vos emails (Gmail, etc.)"
Write-Host "2. VÃ©rifiez vos messages WhatsApp"
Write-Host "3. Consultez l'interface: http://localhost:5000/Home/HistoriqueTest"
Write-Host "4. VÃ©rifiez les logs de l'application AlertSystem"
