...
public sealed class ReservationsWatcher : BackgroundService
{
    ...
    {
        var intervalSec = _config.GetValue<int?>("WatcherIntervals:RESASeconds") ?? 60;
        ...
        while (!stoppingToken.IsCancellationRequested)
        {
            ...
            {
                _logger.LogError(ex, "ReservationsWatcher tick failed");
            }
    ...
    private async Task TickAsync(CancellationToken ct)
    {
        ...
        // Example raw SQL to find upcoming check-ins without deep EF mappings.
        // NB: The columns come from the schema hints. Adjust as needed with your exact column names.
