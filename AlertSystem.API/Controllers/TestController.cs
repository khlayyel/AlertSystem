    ...
    public sealed class TestController : ControllerBase
    {
        ...
        public async Task<IActionResult> TestDatabase()
        {
            try
            {
                ...
                _logger.LogInformation("Table counts - AlertType: {AlertType}, Statut: {Statut}, Etat: {Etat}, ApiClients: {ApiClients}",
                    alertTypeCount, statutCount, etatCount, apiClientCount);
