...
namespace AlertSystem.Service.Services
{
    public interface INotificationPublisher {
        Task PublishAlertStatusChanged(int alertId, string status);
    }
    ...
    public sealed class AlertCancellationService
    {
        ...
        public AlertCancellationService(IServiceProvider serviceProvider, ILogger<AlertCancellationService> logger, INotificationPublisher? notificationPublisher = null)
        {
        ...
        private async Task UpdateAlertStatus(int alertId, string status)
        {
            ...
            try
            {
                if (_notificationPublisher != null) {
                    await _notificationPublisher.PublishAlertStatusChanged(alertId, status);
                }
            }
            catch (Exception ex)
            {
